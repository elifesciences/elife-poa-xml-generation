...
class crossrefXML(object):
    ...
    def __init__(self, poa_articles, pub_date = None):
        ...
        self.elife_doi_batch_id = "elife-crossref-" + batch_doi + time.strftime("%Y%m%d%H%M%S", self.pub_date)
    ...
    def crossref_mime_type(self, jats_mime_type):
        ...
        mime_types['application/pptx'] = 'application/vnd.openxmlformats-officedocument.presentationml.presentation'
        mime_types['application/xlsx'] = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'
        mime_types['application/docx'] = 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'
