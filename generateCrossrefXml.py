...
class crossrefXML(object):
    ...
    def __init__(self, poa_article, pub_date = None):
        """
        set the root node
        ...
        # Generate batch id
        self.elife_doi_batch_id = "elife-" + time.strftime("%Y-%m-%d_%H:%M:%S", self.pub_date) + "-PoA"
    ...
    def build(self, root, poa_article):
        self.set_head(self.root, poa_article)
        self.set_body(self.root, poa_article)

    def set_head(self, parent, poa_article):
...
if __name__ == '__main__':
    ...
    eXML = crossrefXML(poa_articles[0])
