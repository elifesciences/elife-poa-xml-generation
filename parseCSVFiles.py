...
def get_article_attributes(article_id, attribute_type, attribute_label):
	...
	logger.info("artilce_id: " + str(article_id) + " attribute_type: " + attribute_type + " attribute_label:" +  attribute_label)
	attributes = []
...
def get_receipt_date(article_id):
	attribute = get_article_attributes(article_id, "received", COLUMN_HEADINGS["receipt_date"])[0]
	return attribute
